                  ...
                  {platforms.map((p) => (
                    <div key={p} style={{ marginBottom: 10 }}>
                      <div className="row" style={{ marginBottom: 4 }}>
                        ...
                        <span style={{ fontSize: 'var(--text-sm)' }}>{platformLabel(p, platLabels)}</span>
                        <div className="spacer" />
                        <button
          ...
          {schedules.length > 0 && (
            <div className="card" style={{ marginBottom: 14 }}>
              ...
              {schedules.map((s) => {
                ...
                return (
                  <div key={s.id} className="row" style={{ fontSize: 'var(--text-sm)', marginBottom: 8 }}>
          ...
          {versions.length > 0 && (
            <div className="card" style={{ marginBottom: 14 }}>
              <div className="row">
                ...
                <div className="spacer" />
                <span className="muted" style={{ fontSize: 'var(--text-xs)' }}>{versions.length} نسخة</span>
              </div>
