          ...
          <div className="card">
            ...
            {posts.map((p) => (
              <div key={p.id} style={{ padding: '9px 0', borderBottom: '1px solid var(--border)', cursor: 'pointer' }} onClick={() => navigate(`/editor/${p.id}`)}>
                ...
                <div className="muted" style={{ fontSize: 'var(--text-sm)' }} dangerouslySetInnerHTML={{ __html: p.snippet }} />
              </div>
            ))}
          ...
          <div className="card">
            ...
            {news.map((n) => (
              <div key={n.id} style={{ padding: '9px 0', borderBottom: '1px solid var(--border)' }}>
                ...
                <div className="muted" style={{ fontSize: 'var(--text-sm)' }} dangerouslySetInnerHTML={{ __html: n.snippet }} />
              </div>
            ))}
