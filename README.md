...
- **سجلّ مؤشرات كامل** يطبّق «دليل مؤشرات التسويق والتحليل»: مئةٌ وثلاثة عشر مؤشراً في عشر طبقات، كلٌّ بفئته ووحدته ودوريته ومستهدفه، وثلاثةٌ وستون منها تُحتسب آلياً.
