...
/* ═══ احتساب الفترات الماضية ═══
   ...
   فيُعاد احتسابُ ما قبل السابقة على دفعات: ثلاث فتراتٍ في كل ساعة، ما لم
   يُحتسب قطّ أوّلاً ثم أقدمُها احتساباً — فتدور على الفترات التسع والعشرين
   كل عشر ساعاتٍ تقريباً. وثلاثٌ لأن الفترة الواحدة تكتب مئة قيمةٍ أو أكثر،
   كلٌّ باستعلام، وللاستدعاء ألفُ استعلامٍ لـD1.
